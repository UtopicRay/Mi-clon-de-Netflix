    ...
    return (
        <>
            ...
            <main className=''>
                <div
                    style={{
                        background: `linear-gradient(to bottom, rgba(0, 0, 0, 1) 0%, rgba(0, 0, 0, 0.5) 50%, rgba(0, 0, 0, 0) 100%), url("https://image.tmdb.org/t/p/w1280/${data.poster_path}") no-repeat center center fixed `,
                    ...
                    <MovieCard poster_path={data.poster_path} production_companies={data.production_companies}
                               ...
                               tagline={data.tagline} vote_average={data.vote_average} genres={data.genres}
                    ></MovieCard>
                </div>
                <div className='px-4'>
